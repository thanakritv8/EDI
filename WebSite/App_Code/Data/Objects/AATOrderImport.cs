...
namespace MyCompany.Data.Objects
{
    ...
    public partial class AATOrderImport
    {
        ...
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(
                    decimal? autoId, 
                    string orderBy, 
                    ...
                    string statusCode)
        {
            return new AATOrderImportFactory().Select(autoId, orderBy, deliveryDestination, customerMatCode, partsDevision, customerPO, key1, key2, key3, reliabilityDevision, deliveryDate, quantity, unit, plngPeriod, sAPCode, fileId, statusCode);
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(MyCompany.Data.Objects.AATOrderImport qbe)
        {
            return new AATOrderImportFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new AATOrderImportFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new AATOrderImportFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new AATOrderImportFactory().Select(filter, sort, AATOrderImportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, string sort, params FieldValue[] parameters)
        {
        ...
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, BusinessObjectParameters parameters)
        {
            return new AATOrderImportFactory().Select(filter, null, AATOrderImportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, params FieldValue[] parameters)
        {
        ...
        public static MyCompany.Data.Objects.AATOrderImport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new AATOrderImportFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.AATOrderImport SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new AATOrderImportFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.AATOrderImport SelectSingle(decimal? autoId)
        {
    ...
    public partial class AATOrderImportFactory
    {
        ...
        public List<MyCompany.Data.Objects.AATOrderImport> Select(
                    decimal? autoId, 
                    string orderBy, 
                    string deliveryDestination, 
                    string customerMatCode, 
                    ...
                    string dataView)
        {
            ...
            return page.ToList<MyCompany.Data.Objects.AATOrderImport>();
        }
        
        public List<MyCompany.Data.Objects.AATOrderImport> Select(MyCompany.Data.Objects.AATOrderImport qbe)
        {
        ...
        public MyCompany.Data.Objects.AATOrderImport SelectSingle(decimal? autoId)
        {
            List<MyCompany.Data.Objects.AATOrderImport> list = Select(autoId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
        ...
        public List<MyCompany.Data.Objects.AATOrderImport> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.AATOrderImport> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.AATOrderImport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.AATOrderImport> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Data.Objects.AATOrderImport theAATOrderImport, MyCompany.Data.Objects.AATOrderImport original_AATOrderImport)
        {
        ...
        protected virtual int ExecuteAction(MyCompany.Data.Objects.AATOrderImport theAATOrderImport, MyCompany.Data.Objects.AATOrderImport original_AATOrderImport, string lastCommandName, string commandName, string dataView)
        {
        ...
        public virtual int Update(MyCompany.Data.Objects.AATOrderImport theAATOrderImport, MyCompany.Data.Objects.AATOrderImport original_AATOrderImport)
        {
            return ExecuteAction(theAATOrderImport, original_AATOrderImport, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Data.Objects.AATOrderImport theAATOrderImport)
        {
            return Update(theAATOrderImport, SelectSingle(theAATOrderImport.AutoId));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Data.Objects.AATOrderImport theAATOrderImport)
        {
            return ExecuteAction(theAATOrderImport, new AATOrderImport(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Data.Objects.AATOrderImport theAATOrderImport)
        {
