...
namespace MyCompany.Data.Objects
{
    ...
    public partial class vw_SD_T08
    {
        ...
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(
                    ...
                    string vatRate)
        {
            return new vw_SD_T08Factory().Select(salesDocumentType, salesOrganization, distributionChannel, division, soldTo, shipTo, purchaseOrderNumber, salesDocument, invoiceNumber, salesDocumentItemCat, materialCode, keyField1, keyField2, keyField3, rokiDeliveryPlant, rokiDelStorageLoc, goodsMovementDate, lastDeliveryPlant, lastDelStorageLoc, netValueInDocCurrency, sdDocumentCurrency, incotermPart1, incotermPart2, scheduleLineCat, scheduleLineDate, arrivalTime, expr1, salesUnit, fromTo, plantCode, addCode, vatRate);
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(MyCompany.Data.Objects.vw_SD_T08 qbe)
        {
            return new vw_SD_T08Factory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new vw_SD_T08Factory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new vw_SD_T08Factory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new vw_SD_T08Factory().Select(filter, sort, vw_SD_T08Factory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, string sort, params FieldValue[] parameters)
        {
            return new vw_SD_T08Factory().Select(filter, sort, vw_SD_T08Factory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, BusinessObjectParameters parameters)
        {
            return new vw_SD_T08Factory().Select(filter, null, vw_SD_T08Factory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, params FieldValue[] parameters)
        {
            return new vw_SD_T08Factory().Select(filter, null, vw_SD_T08Factory.SelectView, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.vw_SD_T08 SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new vw_SD_T08Factory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.vw_SD_T08 SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new vw_SD_T08Factory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
    ...
    public partial class vw_SD_T08Factory
    {
        
        public vw_SD_T08Factory()
        {
        }
        ...
        public static string SelectView
        {
            get
            {
                return Controller.GetSelectView("vw_SD_T08");
            }
        }
        ...
        public static string InsertView
        {
            get
            {
                return Controller.GetInsertView("vw_SD_T08");
            }
        }
        ...
        public static string UpdateView
        {
            get
            {
                return Controller.GetUpdateView("vw_SD_T08");
            }
        }
        ...
        public static string DeleteView
        {
            get
            {
                return Controller.GetDeleteView("vw_SD_T08");
            }
        }
        
        public static vw_SD_T08Factory Create()
        {
            return new vw_SD_T08Factory();
        }
        ...
        public List<MyCompany.Data.Objects.vw_SD_T08> Select(MyCompany.Data.Objects.vw_SD_T08 qbe)
        {
        ...
        public List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            ...
            ViewPage page = c.GetPage("vw_SD_T08", dataView, request);
            return page.ToList<MyCompany.Data.Objects.vw_SD_T08>();
        }
        
        public List<MyCompany.Data.Objects.vw_SD_T08> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.vw_SD_T08> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.vw_SD_T08 SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.vw_SD_T08> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
