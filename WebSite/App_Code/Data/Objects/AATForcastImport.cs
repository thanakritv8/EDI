...
namespace MyCompany.Data.Objects
{
    ...
    public partial class AATForcastImport
    {
        ...
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(
                    decimal? autoId, 
                    string orderBy, 
                    ...
                    string statusCode)
        {
            return new AATForcastImportFactory().Select(autoId, orderBy, deliveryDestination, customerMatCode, partsDevision, customerPO, key1, key2, key3, reliabilityDevision, deliveryDate, quantity, unit, plngPeriod, sAPCode, fileId, statusCode);
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(MyCompany.Data.Objects.AATForcastImport qbe)
        {
            return new AATForcastImportFactory().Select(qbe);
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
            return new AATForcastImportFactory().Select(filter, sort, dataView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, string sort, string dataView, params FieldValue[] parameters)
        {
            return new AATForcastImportFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, string sort, BusinessObjectParameters parameters)
        {
            return new AATForcastImportFactory().Select(filter, sort, AATForcastImportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, string sort, params FieldValue[] parameters)
        {
        ...
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, BusinessObjectParameters parameters)
        {
            return new AATForcastImportFactory().Select(filter, null, AATForcastImportFactory.SelectView, parameters);
        }
        
        public static List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, params FieldValue[] parameters)
        {
        ...
        public static MyCompany.Data.Objects.AATForcastImport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            return new AATForcastImportFactory().SelectSingle(filter, parameters);
        }
        
        public static MyCompany.Data.Objects.AATForcastImport SelectSingle(string filter, params FieldValue[] parameters)
        {
            return new AATForcastImportFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Data.Objects.AATForcastImport SelectSingle(decimal? autoId)
        {
    ...
    public partial class AATForcastImportFactory
    {
        ...
        public List<MyCompany.Data.Objects.AATForcastImport> Select(
                    decimal? autoId, 
                    string orderBy, 
                    string deliveryDestination, 
                    string customerMatCode, 
                    ...
                    string dataView)
        {
            ...
            return page.ToList<MyCompany.Data.Objects.AATForcastImport>();
        }
        
        public List<MyCompany.Data.Objects.AATForcastImport> Select(MyCompany.Data.Objects.AATForcastImport qbe)
        {
        ...
        public MyCompany.Data.Objects.AATForcastImport SelectSingle(decimal? autoId)
        {
            List<MyCompany.Data.Objects.AATForcastImport> list = Select(autoId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
        ...
        public List<MyCompany.Data.Objects.AATForcastImport> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Data.Objects.AATForcastImport> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public MyCompany.Data.Objects.AATForcastImport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Data.Objects.AATForcastImport> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Data.Objects.AATForcastImport theAATForcastImport, MyCompany.Data.Objects.AATForcastImport original_AATForcastImport)
        {
            List<FieldValue> values = new List<FieldValue>();
            values.Add(new FieldValue("AutoId", original_AATForcastImport.AutoId, theAATForcastImport.AutoId));
        ...
        protected virtual int ExecuteAction(MyCompany.Data.Objects.AATForcastImport theAATForcastImport, MyCompany.Data.Objects.AATForcastImport original_AATForcastImport, string lastCommandName, string commandName, string dataView)
        {
        ...
        public virtual int Update(MyCompany.Data.Objects.AATForcastImport theAATForcastImport, MyCompany.Data.Objects.AATForcastImport original_AATForcastImport)
        {
            return ExecuteAction(theAATForcastImport, original_AATForcastImport, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Data.Objects.AATForcastImport theAATForcastImport)
        {
            return Update(theAATForcastImport, SelectSingle(theAATForcastImport.AutoId));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Data.Objects.AATForcastImport theAATForcastImport)
        {
            return ExecuteAction(theAATForcastImport, new AATForcastImport(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Data.Objects.AATForcastImport theAATForcastImport)
        {
