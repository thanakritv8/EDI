...
{
	public partial class HATCForcastMonthImportBusinessRule : MyCompany.Rules.SharedBusinessRules
    {
        ...
        protected override void ExecuteAction(ActionArgs args, ActionResult result)
        {
            ...
            {
                using (SqlProcedure sp = new SqlProcedure("sp_HATC_ForcastMonth_Execute"))
                {
