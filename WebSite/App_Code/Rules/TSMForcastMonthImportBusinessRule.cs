...
{
	public partial class TSMForcastMonthImportBusinessRule : MyCompany.Rules.SharedBusinessRules
    {
        ...
        protected override void ExecuteAction(ActionArgs args, ActionResult result)
        {
            ...
            {
                using (SqlProcedure sp = new SqlProcedure("sp_TSM_ForcastMonth_Execute"))
                {
