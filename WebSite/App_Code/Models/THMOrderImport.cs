...
{
	public partial class THMOrderImportModel : BusinessRulesObjectModel
    {
        ...
        public THMOrderImportModel()
        {
        }
        
        public THMOrderImportModel(BusinessRules r) : 
                base(r)
        {
        }
    ...
    public partial class THMOrderImport : THMOrderImportModel
    {
        
        public static List<MyCompany.Models.THMOrderImport> Select(
                    decimal? autoId, 
                    string orderBy, 
        ...
        {
            return new THMOrderImportFactory().Select(autoId, orderBy, deliveryDestination, customerMatCode, partsDevision, customerPO, key1, key2, key3, reliabilityDevision, deliveryDate, quantity, unit, plngPeriod, sAPCode, filename, statusCode, plantCode, addCode, arrivaltime, fromTo, deliveryDestinationCode);
        }
        
        public static List<MyCompany.Models.THMOrderImport> Select(string filter, string sort, string dataView, params System.Object[] parameters)
        {
            return new THMOrderImportFactory().Select(filter, sort, dataView, new BusinessObjectParameters(parameters));
        }
        
        public static List<MyCompany.Models.THMOrderImport> Select(string filter, string sort, params System.Object[] parameters)
        {
        ...
        public static List<MyCompany.Models.THMOrderImport> Select(string filter, params System.Object[] parameters)
        {
        ...
        public static MyCompany.Models.THMOrderImport SelectSingle(string filter, params System.Object[] parameters)
        {
            return new THMOrderImportFactory().SelectSingle(filter, new BusinessObjectParameters(parameters));
        }
        
        public static MyCompany.Models.THMOrderImport SelectSingle(decimal? autoId)
        {
    ...
    public partial class THMOrderImportFactory
    {
        ...
        public List<MyCompany.Models.THMOrderImport> Select(
                    decimal? autoId, 
                    string orderBy, 
                    string deliveryDestination, 
                    string customerMatCode, 
                    ...
                    string dataView)
        {
            ...
            return page.ToList<MyCompany.Models.THMOrderImport>();
        }
        ...
        public List<MyCompany.Models.THMOrderImport> Select(MyCompany.Models.THMOrderImport qbe)
        {
        ...
        public List<MyCompany.Models.THMOrderImport> Select(string filter, BusinessObjectParameters parameters)
        {
            return Select(filter, null, SelectView, parameters);
        }
        
        public List<MyCompany.Models.THMOrderImport> SelectSingle(string filter, string sort, BusinessObjectParameters parameters)
        {
            return Select(filter, sort, SelectView, parameters);
        }
        
        public List<MyCompany.Models.THMOrderImport> Select(string filter, string sort, string dataView, BusinessObjectParameters parameters)
        {
        ...
        public MyCompany.Models.THMOrderImport SelectSingle(decimal? autoId)
        {
            List<MyCompany.Models.THMOrderImport> list = Select(autoId, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            if (list.Count == 0)
            	return null;
            return list[0];
        }
        
        public MyCompany.Models.THMOrderImport SelectSingle(string filter, BusinessObjectParameters parameters)
        {
            List<MyCompany.Models.THMOrderImport> list = Select(filter, parameters);
            if (list.Count > 0)
            	return list[0];
            return null;
        }
        
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Models.THMOrderImport theTHMOrderImport, MyCompany.Models.THMOrderImport original_THMOrderImport)
        {
            ...
            values.Add(new FieldValue("Filename", original_THMOrderImport.Filename, theTHMOrderImport.Filename));
            values.Add(new FieldValue("StatusCode", original_THMOrderImport.StatusCode, theTHMOrderImport.StatusCode));
            values.Add(new FieldValue("PlantCode", original_THMOrderImport.PlantCode, theTHMOrderImport.PlantCode));
            values.Add(new FieldValue("AddCode", original_THMOrderImport.AddCode, theTHMOrderImport.AddCode));
            values.Add(new FieldValue("Arrivaltime", original_THMOrderImport.Arrivaltime, theTHMOrderImport.Arrivaltime));
            values.Add(new FieldValue("FromTo", original_THMOrderImport.FromTo, theTHMOrderImport.FromTo));
            values.Add(new FieldValue("DeliveryDestinationCode", original_THMOrderImport.DeliveryDestinationCode, theTHMOrderImport.DeliveryDestinationCode));
            return values.ToArray();
        }
        
        protected virtual int ExecuteAction(MyCompany.Models.THMOrderImport theTHMOrderImport, MyCompany.Models.THMOrderImport original_THMOrderImport, string lastCommandName, string commandName, string dataView)
        {
        ...
        public virtual int Update(MyCompany.Models.THMOrderImport theTHMOrderImport, MyCompany.Models.THMOrderImport original_THMOrderImport)
        {
            return ExecuteAction(theTHMOrderImport, original_THMOrderImport, "Edit", "Update", UpdateView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(MyCompany.Models.THMOrderImport theTHMOrderImport)
        {
            return Update(theTHMOrderImport, SelectSingle(theTHMOrderImport.AutoId));
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(MyCompany.Models.THMOrderImport theTHMOrderImport)
        {
            return ExecuteAction(theTHMOrderImport, new THMOrderImport(), "New", "Insert", InsertView);
        }
        
        [System.ComponentModel.DataObjectMethod(System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(MyCompany.Models.THMOrderImport theTHMOrderImport)
        {
