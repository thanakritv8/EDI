...
namespace MyCompany.Models
{
    ...
    public partial class HATCForcastImport : HATCForcastImportModel
    {
        ...
        {
            return new HATCForcastImportFactory().Select(autoId, orderBy, deliveryDestination, customerMatCode, partsDevision, customerPO, key1, key2, key3, reliabilityDevision, deliveryDate, quantity, unit, plngPeriod, sAPCode, fileId, statusCode, deliveryDestinationCode);
        }
    ...
    public partial class HATCForcastImportFactory
    {
        ...
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Models.HATCForcastImport theHATCForcastImport, MyCompany.Models.HATCForcastImport original_HATCForcastImport)
        {
            ...
            values.Add(new FieldValue("DeliveryDestinationCode", original_HATCForcastImport.DeliveryDestinationCode, theHATCForcastImport.DeliveryDestinationCode));
